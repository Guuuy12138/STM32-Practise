...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, LED_LAN_Pin|LED_LV_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(LED_HONG_GPIO_Port, LED_HONG_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : LED_LAN_Pin LED_LV_Pin */
  GPIO_InitStruct.Pin = LED_LAN_Pin|LED_LV_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pin : LED_HONG_Pin */
  GPIO_InitStruct.Pin = LED_HONG_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(LED_HONG_GPIO_Port, &GPIO_InitStruct);
